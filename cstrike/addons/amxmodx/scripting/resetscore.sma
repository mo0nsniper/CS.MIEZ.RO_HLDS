...
public plugin_init()
{
	register_plugin("MIEZ - Reset Score", "1.0", "Silenttt & mo0n_sniper")
...
public reset_score(id)
{
	...
	if(get_pcvar_num(pcvar_Display) == 1)
	{
		...
		client_print_color(0, id , "^4%s si-a resetat scorul", name)
	}
	else
	{
		//client_print(id, print_chat, "You have just reset your score")
		client_print_color(id, id , "^4Ti-ai resetat scorul")
	}
...
public advertise()
{
	...
	show_hudmessage(0, "Tastand /rs poti sa iti resetezi scorul")
}
...
public connectmessage(id)
{
	...
	client_print(id, print_chat, "Tastand /rs poti sa iti resetezi scorul")
	}
}
